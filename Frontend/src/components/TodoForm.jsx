  ...
  return (
    <>
      <form onSubmit={handleSubmit} className='flex flex-col h-auto w-full lg:w-1/2 p-5'>
        ...
        <button className='w-auto px-2 py-2 rounded  bg-[#5659f6] text-shadow-blue-50 font-bold text-xl active:scale-101 active:text-white'>{editedTodo ? 'Update Taks' : ' + Add Task'}</button>
